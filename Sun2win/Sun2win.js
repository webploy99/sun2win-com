...
function head1(){
  const headerContentt = document.createElement("div")
  headerContentt.innerHTML = `
    ...
    header1.appendChild(headerContentt)
}
head1();

const footer1 = document.querySelector("#footer1")
function foot1(){
    const footerContentt = document.createElement("section")
    footerContentt.innerHTML= `
        ...
        <div class="text-[#ffffff80] text-[12px] text-center pt-5">
            <p>Copyright 2024 <strong> © sun2win.com</strong></p>
        </div>
    </section>`
